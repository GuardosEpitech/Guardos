        ...
        <div>
          ...
          <div className={styles.cookieBanner}>
            ...
            <p>
              ...
              <a href="/privacy" target="_blank" rel="noopener noreferrer">{t('components.CookieBanner.privacy')}</a>
              {t('components.CookieBanner.and')}
              <a href="/cookiestatement" target="_blank" rel="noopener noreferrer">{t('components.CookieBanner.cookie')}</a>.
            </p>
