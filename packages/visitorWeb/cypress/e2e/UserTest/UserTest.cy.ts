describe('Register', () => {
    it('passes', () => {
        ...
        cy.get('.V3JgFjoBAN8BwxEGAGJx > .cCywpriAWfC5rZb8oRYj > .jgdtqJiol3q8AD6AO_6l > .BeRjX90Zejj_RRtK0TjB > a').click();
        cy.get('.d5Iqr4Hr_KswpjgdaQ3C > .Ya4lhXp5Fb_4KVGtJDrV > form > .n9NneHtW52Iramqkd4mx > .mUi5TtzSixkfc6ylvswE').click();
...
describe('Login', () => {
    it('passes', () => {
        ...
        cy.get('.Ya4lhXp5Fb_4KVGtJDrV > form > .MuiFormControl-root').eq(0).find('.MuiInputBase-root > .MuiInputBase-input').type('CypressTest');
